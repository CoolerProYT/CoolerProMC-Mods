...
export default function LakeFeatureFix() {
    return (
        <main>
            <section className={`w-full relative bg-no-repeat bg-cover bg- bg-center h-fit`}>
                ...
                <section className="w-10/12 grid lg:grid-cols-3 xl:grid-cols-2 mx-auto justify-center items-center relative py-10 z-10">
                    <div className="flex flex-col justify-between items-center lg:col-span-2 xl:col-span-1">
                        <div>
                            <span className="text-3xl md:text-5xl font-semibold tracking-wider">Lake Feature Fix</span>
                        </div>
                        <div className="mt-8 grid gap-6 lg:gap-1 xl:gap-4 grid-cols-2 md:grid-cols-4">
                            ...
                            <LinkTextIconButton link="https://www.curseforge.com/minecraft/mc-mods/lake-feature-fix" borderColor="#2e2e2e" bgcolor="#1e1e1e" color="#f8f9fa" hoverBgColor="#a3561f" icon={<img src="cf.png" className="h-6 w-6"/>} text="CurseForge"/>
                            <LinkTextIconButton link="https://modrinth.com/mod/lake-feature-fix" borderColor="#2e2e2e" bgcolor="#1e1e1e" color="#f8f9fa" hoverBgColor="#178b46" icon={<img src="modrinth.png" className="h-6 w-6"/>} text="Modrinth"/>
                            <LinkTextIconButton link="" borderColor="#2e2e2e" bgcolor="#1e1e1e" color="#f8f9fa" hoverBgColor="#f59e3b" icon={<LanguageIcon />} text="Wiki"/>
                        </div>
                    </div>
                    <div className="justify-center items-center hidden lg:flex">
                        <img src="lake_feature_fix.png" className="w-6/12 shadow-lg rounded-2xl"/>
                    </div>
                </section>
            </section>
            <section className="w-full">
                <section className="w-10/12 py-10 mx-auto">
                    ...
                    <div className="mt-5 flex justify-center flex-wrap">
                        <VersionCard from={"from-orange-500"} to={"to-orange-600"} version={"1.21.1"} neoforge={true} fabric={true}/>
            ...
            <section className="w-full">
                <section className="w-10/12 py-10 mx-auto">
                    ...
                    <div className="mt-5 flex justify-center flex-wrap">
                        <FeatureCard img={"lff_feature/lake.png"} title={"Crash Fix"} description={"Fixed sometimes crashing when generating custom lake feature."}/>
                    </div>
                </section>
            </section>
        </main>
